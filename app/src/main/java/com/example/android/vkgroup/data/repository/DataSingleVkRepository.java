...
public class DataSingleVkRepository implements VkRepository {
    ...
    private VKRequest request = VKApi.groups().get(VKParameters.from(VKApiConst.FIELDS, "members_count", VKApiConst.EXTENDED, 1));
    ...
    public Single<List<GroupModel>> getListGroupsSingle() {
        return Single.create(subscriber -> request.executeWithListener(new VKRequest.VKRequestListener() {
